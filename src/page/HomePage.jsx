  ...
  return (
    <>
       {/* <Header/> */}
            ...
            <div className="row align-items-center" style={{height:100+'vh'}}>
                ...
                <div className="col-md-6">
                    <div className="w-50 m-auto animate__animated animate__backInRight">
                        <img className="foto-principal" width="100%" src='./assets/images/foto-perfil.png' alt="Foto personal"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <SkillsGridCard/>
        <div  className="encabezado container my-5">
            <h1 id="trabajos-recientes" className="saira text-center">DESARROLLOS DESTACADOS</h1>
        </div>
        <RecentWorkGrid/>
        <div className="container mb-5">
            <div className="row text-center border p-1 mb-5">
